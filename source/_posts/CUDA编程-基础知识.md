...
![共享内存矩阵乘法](https://raw.githubusercontent.com/lyf35/blog_figures/main/img/20210531214456.png)
...
- 算数操作：如果一些算数操作有CUDA内置函数已经实现过，则优先使用函数操作进行计算，例如单精度除法运算等；在运算精度允许的条件下，尽可能使用单精度浮点数；等等。对于CUDA的内置数学函数，可以参考。而对于矩阵运算而言，则可以使用cuBLAS库中的函数。
...
13. [cublas 实战_thesby的专栏-CSDN博客_cublas](https://blog.csdn.net/thesby/article/details/52728529)
14. The CUDA Handbook
